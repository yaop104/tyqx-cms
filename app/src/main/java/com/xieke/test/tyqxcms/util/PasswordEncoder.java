...
public class PasswordEncoder {
    ...
    public static boolean checkPassWord(String passWord, String salt, String pass){
        //散列次数
        int hashIterations = 2;
        //第1个参数：散列算法
        //第2个参数：明文，原始密码
        //第3个参数：盐，通过使用随机数
        //第4个参数：散列的次数，比如散列两次
        SimpleHash simpleHash = new SimpleHash("md5", pass, salt, hashIterations);
        return  passWord.equals(simpleHash.toString()) ? true : false;
    }
